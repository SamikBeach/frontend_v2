...
export const submitFeedback = async (
  ...
  const response = await api.post<FeedbackResponseDto>(
    '/feedback',
    feedbackData
  );
...
export const getAllFeedback = async (
  ...
  const response = await api.get<FeedbackListResponseDto>(
...
export const getFeedbackById = async (
  ...
  const response = await api.get<FeedbackDetailDto>(`/feedback/${id}`);
  return response.data;
};
...
export const updateFeedbackResolutionStatus = async (
  ...
  const response = await api.patch<FeedbackDetailDto>(
    `/feedback/${id}/resolve`,
    { isResolved }
  );
  return response.data;
