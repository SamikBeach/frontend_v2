          ...
          <div className="space-y-6 md:grid md:grid-cols-[380px_1fr] md:gap-10 md:space-y-0">
            ...
            <div className="space-y-6">
              ...
              <div className="relative mx-auto w-44 overflow-hidden rounded-2xl bg-gray-50 md:w-56 lg:w-64">
                <div className="h-[264px] w-full animate-pulse bg-gray-200 md:h-[320px]" />
              </div>
              {/* 제목/저자/출판사/출간일 */}
              <div className="space-y-2 px-1 md:px-0">
                <div className="text-center md:text-left">
                  <div className="mx-auto inline-block h-7 w-32 animate-pulse rounded bg-gray-200 md:mx-0 md:h-8 md:w-48" />
                  <div className="ml-2 inline-block h-5 w-12 animate-pulse rounded-full bg-gray-200 align-text-bottom" />
                  <div className="ml-1 inline-block h-5 w-10 animate-pulse rounded-full bg-gray-200 align-text-bottom" />
                </div>
                <div className="mx-auto h-5 w-24 animate-pulse rounded bg-gray-200 md:mx-0 md:w-32" />
                <div className="mx-auto h-5 w-20 animate-pulse rounded bg-gray-200 md:mx-0 md:w-28" />
                <div className="mx-auto h-5 w-28 animate-pulse rounded bg-gray-200 md:mx-0 md:w-36" />
              </div>
              {/* 별점 정보 스켈레톤 */}
                    ...
                    .map((_, index) => (
                      ...
                      >
                        <div className="flex items-start gap-3.5">
                          <div className="mt-0.5 h-9 w-9 flex-shrink-0 animate-pulse rounded-full bg-gray-200" />
